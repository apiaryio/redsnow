...
module RedSnow
  ...
  class Object
    ...
    def deep_symbolize_keys
      return reduce({}) { |memo, (k, v)| memo[k.to_sym] = v.deep_symbolize_keys; memo } if self.is_a? Hash
      return reduce([]) { |memo, v | memo << v.deep_symbolize_keys; memo } if self.is_a? Array
      self
    end
